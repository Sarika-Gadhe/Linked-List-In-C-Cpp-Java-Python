...
int SinglyCircularLL :: CountEven()
{
    int iCountEven = 0;
...
int SinglyCircularLL :: Summation()
{
    int iSum = 0;
...
int SinglyCircularLL ::  Frequency(int iNo)
{
    int iFrequency = 0;
...
bool SinglyCircularLL ::  Search(int iNo)
{
